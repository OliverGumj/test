...
public class CodeGenerator {
    ...
    public static void main(String[] args) {
        ...
        dataSourceConfig.setUrl("jdbc:mysql://localhost:3306/sharding_jdbc?useUnicode=true&characterEncoding=UTF-8&useSSL=false&serverTimezone=GMT%2B8");
